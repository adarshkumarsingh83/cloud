import com.alexa.greet.GreetSpeechlet;
...
/**
 * Shared launcher for executing all greet skills within a single servlet container.
 */
public final class Launcher {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        context.addServlet(new ServletHolder(createServlet(new GreetSpeechlet())), "/hello");
        server.start();
        server.join();
    }
